...
core.i_cache.cachedat.ram.r_data[4] <= {6'o10,5'h1,5'h0,16'hf7ef};

core.i_cache.cachedat.ram.r_data[5] <= {6'o45,5'h11,5'h1,5'h1f,11'h001};

core.i_cache.cachedat.ram.r_data[6] <= {6'o10,5'h11,5'h0,16'hf7ef};
core.i_cache.cachedat.ram.r_data[7] <= {6'o10,5'h11,5'h0,16'h0001};
core.i_cache.cachedat.ram.r_data[8] <= {6'o57,5'h10,5'h1,16'h0010};
core.i_cache.cachedat.ram.r_data[9] <= {6'o10,5'h11,5'h0,16'hf7ef};
core.i_cache.cachedat.ram.r_data[10] <= {6'o10,5'h11,5'h0,16'h0012};
core.i_cache.cachedat.ram.r_data[11] <= {6'o57,5'h10,5'h1,16'h0010};
core.i_cache.cachedat.ram.r_data[12] <= {6'o10,5'h11,5'h0,16'hf7ef};
core.i_cache.cachedat.ram.r_data[13] <= {6'o10,5'h11,5'h0,16'h0013};
core.i_cache.cachedat.ram.r_data[14] <= {6'o57,5'h10,5'h1,16'h0010};
core.i_cache.cachedat.ram.r_data[15] <= {6'o10,5'h11,5'h0,16'hf7ef};
core.i_cache.cachedat.ram.r_data[16] <= {6'o10,5'h11,5'h0,16'h0014};
core.i_cache.cachedat.ram.r_data[17] <= {6'o57,5'h10,5'h1,16'h0010};
core.i_cache.cachedat.ram.r_data[18] <= {6'o10,5'h11,5'h0,16'hf7ef};
core.i_cache.cachedat.ram.r_data[19] <= {6'o10,5'h11,5'h0,16'h0015};
core.i_cache.cachedat.ram.r_data[20] <= {6'o57,5'h10,5'h1,16'h0010};
core.i_cache.cachedat.ram.r_data[21] <= {6'o10,5'h11,5'h0,16'hf7ef};
core.i_cache.cachedat.ram.r_data[22] <= {6'o10,5'h11,5'h0,16'h0016};
core.i_cache.cachedat.ram.r_data[23] <= {6'o57,5'h10,5'h1,16'h0010};
core.i_cache.cachedat.ram.r_data[24] <= {6'o10,5'h11,5'h0,16'hf7ef};
core.i_cache.cachedat.ram.r_data[25] <= {6'o57,5'h10,5'h0,16'hffc4};
core.i_cache.cachedat.ram.r_data[26] <= {6'o10,5'h12,5'h13,16'h0017};
core.i_cache.cachedat.ram.r_data[27] <= {6'o57,5'h10,5'h1,16'h0010};
core.i_cache.cachedat.ram.r_data[28] <= {6'o57,5'h10,5'h1,16'h0010};
core.i_cache.cachedat.ram.r_data[29] <= {6'o57,5'h10,5'h1,16'h0010};
core.i_cache.cachedat.ram.r_data[30] <= {6'o57,5'h10,5'h1,16'h0010};


core.i_cache.cachedat.ram.r_data[31] <= {6'o05,5'h1f,5'h1f,5'h1f,11'd9};
core.i_cache.cachedat.ram.r_data[32] <= {6'o05,5'h1f,5'h1f,5'h1f,11'd10};
core.i_cache.cachedat.ram.r_data[33] <= {6'o05,5'h1f,5'h1f,5'h1f,11'd11};
...
//    if (core.cpu.grst)
      begin
        $display("ipca %x rPC %x dOPC %x xOPC %x xBRA %x di/ci/ii %x SKP %x",
...
`define CHANGER 64'h30
always @(negedge CPU_CLK)
  begin
    if (cpu_ctr == (`CHANGER -4))
      record <= 1;
    if (cpu_ctr == (`CHANGER))
      begin
        $display("fire interrupt!   core.i_cache_pc_addr %x",
		 core.i_cache_pc_addr);

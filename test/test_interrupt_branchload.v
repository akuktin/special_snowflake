...
core.i_cache.cachedat.ram.r_data[6] <= {6'o76,5'h1,5'h0,16'h0010};
core.i_cache.cachedat.ram.r_data[7] <= {6'o57,5'h10,5'h1,16'h0010};
core.i_cache.cachedat.ram.r_data[8] <= {6'o54,5'h10,5'h0,16'h0012};
core.i_cache.cachedat.ram.r_data[9] <= {6'o57,5'h10,5'h1,16'h0010};
core.i_cache.cachedat.ram.r_data[10] <= {6'o54,5'h10,5'h0,16'h0013};
core.i_cache.cachedat.ram.r_data[11] <= {6'o57,5'h10,5'h1,16'h0010};
core.i_cache.cachedat.ram.r_data[12] <= {6'o54,5'h10,5'h0,16'h0014};
core.i_cache.cachedat.ram.r_data[13] <= {6'o57,5'h10,5'h1,16'h0010};
core.i_cache.cachedat.ram.r_data[14] <= {6'o54,5'h10,5'h0,16'h0015};
core.i_cache.cachedat.ram.r_data[15] <= {6'o57,5'h10,5'h1,16'h0010};
core.i_cache.cachedat.ram.r_data[16] <= {6'o54,5'h10,5'h0,16'h0016};
...
core.i_cache.cachedat.ram.r_data[19] <= {6'o72,5'h2,5'h0,16'h0010};
core.i_cache.cachedat.ram.r_data[20] <= {6'o54,5'h12,5'h13,16'h0017};
...
core.i_cache.cachedat.ram.r_data[100] <= {6'o05,5'h1f,5'h1f,5'h1f,11'd11};
  ...
  core.cpu.regf.RAM_D.ram.r_data[1] <= 32'hff7f_feff;

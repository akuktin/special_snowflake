...
core.i_cache.cachedat.ram.r_data[8] <= {6'o76,5'h4,5'h0,16'h0004};
core.i_cache.cachedat.ram.r_data[9] <= {6'o10,5'h4,5'h4,16'h1};
core.i_cache.cachedat.ram.r_data[10] <= {6'o76,5'h4,5'h0,16'h0008};
core.i_cache.cachedat.ram.r_data[11] <= {6'o10,5'h4,5'h4,16'h1};
core.i_cache.cachedat.ram.r_data[12] <= {6'o76,5'h4,5'h0,16'h000c};

core.i_cache.cachedat.ram.r_data[14] <= {6'o76,5'h2,5'h0,16'h8024};
core.i_cache.cachedat.ram.r_data[15] <= {6'o10,5'h7,5'h0,16'h1};


//core.i_cache.cachedat.ram.r_data[13] <= {6'o10,5'h18,5'h0,16'h0325};
